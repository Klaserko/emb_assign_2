...
// ==============================================================
`timescale 1ns/1ps
module image_processor_AXI_CPU_s_axi
#(parameter
    ...
    input  wire [7:0]                    img_in_address0,
    input  wire                          img_in_ce0,
    output wire [31:0]                   img_in_q0,
    input  wire [7:0]                    out_r_address0,
...
localparam
    ...
    ADDR_IER         = 12'h008,
    ADDR_ISR         = 12'h00c,
    ADDR_IMG_IN_BASE = 12'h400,
    ADDR_IMG_IN_HIGH = 12'h7ff,
    ADDR_OUT_R_BASE  = 12'h800,
    ADDR_OUT_R_HIGH  = 12'hbff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
//------------------------Instantiation------------------
// int_img_in
image_processor_AXI_CPU_s_axi_ram #(
    .BYTES    ( 4 ),
    .DEPTH    ( 256 )
) int_img_in (
    .clk0     ( ACLK ),
...
assign RVALID  = (rstate == RDDATA) & !int_img_in_read & !int_out_r_read;
...
//------------------------Memory logic-------------------
// img_in
assign int_img_in_address0 = img_in_address0;
assign int_img_in_ce0      = img_in_ce0;
assign int_img_in_we0      = 1'b0;
assign int_img_in_be0      = 1'b0;
assign int_img_in_d0       = 1'b0;
assign img_in_q0           = int_img_in_q0;
assign int_img_in_address1 = ar_hs? raddr[9:2] : waddr[9:2];
...
assign int_out_r_address1  = ar_hs? raddr[9:2] : waddr[9:2];
...
module image_processor_AXI_CPU_s_axi_ram
#(parameter
    BYTES  = 4,
    DEPTH  = 256,
    AWIDTH = log2(DEPTH)
